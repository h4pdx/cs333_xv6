...
main(int argc, char *argv[])
{
  ...
  1c:	68 2f 09 00 00       	push   $0x92f
  21:	6a 02                	push   $0x2
  23:	e8 51 05 00 00       	call   579 <printf>
  ...
  6e:	50                   	push   %eax
  6f:	68 46 09 00 00       	push   $0x946
  74:	6a 02                	push   $0x2
  76:	e8 fe 04 00 00       	call   579 <printf>
...
putc(int fd, char c)
{
 ...
 4ba:	e8 1b ff ff ff       	call   3da <write>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 515:	0f b6 80 d8 0b 00 00 	movzbl 0xbd8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 651:	75 25                	jne    678 <printf+0xff>
          s = "(null)";
 653:	c7 45 f4 62 09 00 00 	movl   $0x962,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 719:	a1 f4 0b 00 00       	mov    0xbf4,%eax
...
free(void *ap)
{
 ...
 7e4:	a3 f4 0b 00 00       	mov    %eax,0xbf4
}
 7e9:	90                   	nop
 7ea:	c9                   	leave  
 7eb:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 80b:	50                   	push   %eax
 80c:	e8 31 fc ff ff       	call   442 <sbrk>
 ...
 842:	83 c4 10             	add    $0x10,%esp
  return freep;
 845:	a1 f4 0b 00 00       	mov    0xbf4,%eax
}
 84a:	c9                   	leave  
 84b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 85e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 861:	a1 f4 0b 00 00       	mov    0xbf4,%eax
 866:	89 45 f0             	mov    %eax,-0x10(%ebp)
 869:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 86d:	75 23                	jne    892 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 86f:	c7 45 f0 ec 0b 00 00 	movl   $0xbec,-0x10(%ebp)
 876:	8b 45 f0             	mov    -0x10(%ebp),%eax
 879:	a3 f4 0b 00 00       	mov    %eax,0xbf4
 87e:	a1 f4 0b 00 00       	mov    0xbf4,%eax
 883:	a3 ec 0b 00 00       	mov    %eax,0xbec
    base.s.size = 0;
 888:	c7 05 f0 0b 00 00 00 	movl   $0x0,0xbf0
 88f:	00 00 00 
  }
 ...
 8e5:	a3 f4 0b 00 00       	mov    %eax,0xbf4
      return (void*)(p + 1);
 ...
 8f0:	eb 3b                	jmp    92d <malloc+0xe1>
    ...
    if(p == freep)
 8f2:	a1 f4 0b 00 00       	mov    0xbf4,%eax
