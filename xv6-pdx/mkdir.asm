...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4d5:	0f b6 80 98 0b 00 00 	movzbl 0xb98(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 611:	75 25                	jne    638 <printf+0xff>
          s = "(null)";
 613:	c7 45 f4 22 09 00 00 	movl   $0x922,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d9:	a1 b4 0b 00 00       	mov    0xbb4,%eax
...
free(void *ap)
{
 ...
 7a4:	a3 b4 0b 00 00       	mov    %eax,0xbb4
}
 7a9:	90                   	nop
 7aa:	c9                   	leave  
 7ab:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 802:	83 c4 10             	add    $0x10,%esp
  return freep;
 805:	a1 b4 0b 00 00       	mov    0xbb4,%eax
}
 80a:	c9                   	leave  
 80b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 81e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 821:	a1 b4 0b 00 00       	mov    0xbb4,%eax
 826:	89 45 f0             	mov    %eax,-0x10(%ebp)
 829:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 82d:	75 23                	jne    852 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 82f:	c7 45 f0 ac 0b 00 00 	movl   $0xbac,-0x10(%ebp)
 836:	8b 45 f0             	mov    -0x10(%ebp),%eax
 839:	a3 b4 0b 00 00       	mov    %eax,0xbb4
 83e:	a1 b4 0b 00 00       	mov    0xbb4,%eax
 843:	a3 ac 0b 00 00       	mov    %eax,0xbac
    base.s.size = 0;
 848:	c7 05 b0 0b 00 00 00 	movl   $0x0,0xbb0
 84f:	00 00 00 
  }
 ...
 8a5:	a3 b4 0b 00 00       	mov    %eax,0xbb4
      return (void*)(p + 1);
 ...
 8b0:	eb 3b                	jmp    8ed <malloc+0xe1>
    ...
    if(p == freep)
 8b2:	a1 b4 0b 00 00       	mov    0xbb4,%eax
