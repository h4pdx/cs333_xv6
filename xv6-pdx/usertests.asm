...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       ...
       e:	68 26 45 00 00       	push   $0x4526
      13:	50                   	push   %eax
      14:	e8 40 41 00 00       	call   4159 <printf>
      19:	83 c4 10             	add    $0x10,%esp

  if(mkdir("iputdir") < 0){
      1c:	83 ec 0c             	sub    $0xc,%esp
      1f:	68 31 45 00 00       	push   $0x4531
    ...
    printf(stdout, "mkdir failed\n");
      ...
      38:	68 39 45 00 00       	push   $0x4539
      3d:	50                   	push   %eax
      3e:	e8 16 41 00 00       	call   4159 <printf>
  ...
  if(chdir("iputdir") < 0){
    ...
    printf(stdout, "chdir iputdir failed\n");
      ...
      67:	68 47 45 00 00       	push   $0x4547
      6c:	50                   	push   %eax
      6d:	e8 e7 40 00 00       	call   4159 <printf>
  ...
  if(unlink("../iputdir") < 0){
    ...
    printf(stdout, "unlink ../iputdir failed\n");
      ...
      96:	68 68 45 00 00       	push   $0x4568
      9b:	50                   	push   %eax
      9c:	e8 b8 40 00 00       	call   4159 <printf>
  ...
  if(chdir("/") < 0){
    ...
    printf(stdout, "chdir / failed\n");
      ...
      c5:	68 84 45 00 00       	push   $0x4584
      ca:	50                   	push   %eax
      cb:	e8 89 40 00 00       	call   4159 <printf>
  ...
  printf(stdout, "iput test ok\n");
      ...
      e0:	68 94 45 00 00       	push   $0x4594
      e5:	50                   	push   %eax
      e6:	e8 6e 40 00 00       	call   4159 <printf>
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      ff:	68 a2 45 00 00       	push   $0x45a2
     104:	50                   	push   %eax
     105:	e8 4f 40 00 00       	call   4159 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     123:	68 b1 45 00 00       	push   $0x45b1
     128:	50                   	push   %eax
     129:	e8 2b 40 00 00       	call   4159 <printf>
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     143:	68 31 45 00 00       	push   $0x4531
     ...
     15c:	68 39 45 00 00       	push   $0x4539
     161:	50                   	push   %eax
     162:	e8 f2 3f 00 00       	call   4159 <printf>
    ...
    if(chdir("iputdir") < 0){
     ...
     172:	68 31 45 00 00       	push   $0x4531
     ...
     18b:	68 be 45 00 00       	push   $0x45be
     190:	50                   	push   %eax
     191:	e8 c3 3f 00 00       	call   4159 <printf>
    ...
    if(unlink("../iputdir") < 0){
     ...
     1a1:	68 5d 45 00 00       	push   $0x455d
     ...
     1ba:	68 68 45 00 00       	push   $0x4568
     1bf:	50                   	push   %eax
     1c0:	e8 94 3f 00 00       	call   4159 <printf>
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1df:	68 d2 45 00 00       	push   $0x45d2
     1e4:	50                   	push   %eax
     1e5:	e8 6f 3f 00 00       	call   4159 <printf>
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     1fe:	68 e4 45 00 00       	push   $0x45e4
     203:	50                   	push   %eax
     204:	e8 50 3f 00 00       	call   4159 <printf>
     209:	83 c4 10             	add    $0x10,%esp
  if(mkdir("oidir") < 0){
     20c:	83 ec 0c             	sub    $0xc,%esp
     20f:	68 f3 45 00 00       	push   $0x45f3
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     228:	68 f9 45 00 00       	push   $0x45f9
     22d:	50                   	push   %eax
     22e:	e8 26 3f 00 00       	call   4159 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     251:	68 b1 45 00 00       	push   $0x45b1
     256:	50                   	push   %eax
     257:	e8 fd 3e 00 00       	call   4159 <printf>
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     26d:	6a 02                	push   $0x2
     26f:	68 f3 45 00 00       	push   $0x45f3
    ...
    if(fd >= 0){
     ...
     28d:	68 10 46 00 00       	push   $0x4610
     292:	50                   	push   %eax
     293:	e8 c1 3e 00 00       	call   4159 <printf>
  ...
  if(unlink("oidir") != 0){
     ...
     2b5:	68 f3 45 00 00       	push   $0x45f3
    ...
    printf(stdout, "unlink failed\n");
     ...
     2ce:	68 34 46 00 00       	push   $0x4634
     2d3:	50                   	push   %eax
     2d4:	e8 80 3e 00 00       	call   4159 <printf>
  ...
  printf(stdout, "openiput test ok\n");
     ...
     2ee:	68 43 46 00 00       	push   $0x4643
     2f3:	50                   	push   %eax
     2f4:	e8 60 3e 00 00       	call   4159 <printf>
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     30d:	68 55 46 00 00       	push   $0x4655
     312:	50                   	push   %eax
     313:	e8 41 3e 00 00       	call   4159 <printf>
     318:	83 c4 10             	add    $0x10,%esp
  fd = open("echo", 0);
     31b:	83 ec 08             	sub    $0x8,%esp
     31e:	6a 00                	push   $0x0
     320:	68 10 45 00 00       	push   $0x4510
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     ...
     33e:	68 60 46 00 00       	push   $0x4660
     343:	50                   	push   %eax
     344:	e8 10 3e 00 00       	call   4159 <printf>
  ...
  fd = open("doesnotexist", 0);
     ...
     362:	6a 00                	push   $0x0
     364:	68 73 46 00 00       	push   $0x4673
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     382:	68 80 46 00 00       	push   $0x4680
     387:	50                   	push   %eax
     388:	e8 cc 3d 00 00       	call   4159 <printf>
  ...
  printf(stdout, "open test ok\n");
     ...
     39d:	68 9e 46 00 00       	push   $0x469e
     3a2:	50                   	push   %eax
     3a3:	e8 b1 3d 00 00       	call   4159 <printf>
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     3bc:	68 ac 46 00 00       	push   $0x46ac
     3c1:	50                   	push   %eax
     3c2:	e8 92 3d 00 00       	call   4159 <printf>
     3c7:	83 c4 10             	add    $0x10,%esp
  fd = open("small", O_CREATE|O_RDWR);
     3ca:	83 ec 08             	sub    $0x8,%esp
     3cd:	68 02 02 00 00       	push   $0x202
     3d2:	68 bd 46 00 00       	push   $0x46bd
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     3f0:	68 c3 46 00 00       	push   $0x46c3
     3f5:	50                   	push   %eax
     3f6:	e8 5e 3d 00 00       	call   4159 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     412:	68 de 46 00 00       	push   $0x46de
     417:	50                   	push   %eax
     418:	e8 3c 3d 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     428:	6a 0a                	push   $0xa
     42a:	68 fa 46 00 00       	push   $0x46fa
     ...
     44a:	68 08 47 00 00       	push   $0x4708
     44f:	50                   	push   %eax
     450:	e8 04 3d 00 00       	call   4159 <printf>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     460:	6a 0a                	push   $0xa
     462:	68 2c 47 00 00       	push   $0x472c
     ...
     482:	68 38 47 00 00       	push   $0x4738
     487:	50                   	push   %eax
     488:	e8 cc 3c 00 00       	call   4159 <printf>
  ...
  printf(stdout, "writes ok\n");
     ...
     4a7:	68 5c 47 00 00       	push   $0x475c
     4ac:	50                   	push   %eax
     4ad:	e8 a7 3c 00 00       	call   4159 <printf>
  ...
  fd = open("small", O_RDONLY);
     ...
     4c6:	6a 00                	push   $0x0
     4c8:	68 bd 46 00 00       	push   $0x46bd
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     4e6:	68 67 47 00 00       	push   $0x4767
     4eb:	50                   	push   %eax
     4ec:	e8 68 3c 00 00       	call   4159 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     522:	68 80 47 00 00       	push   $0x4780
     527:	50                   	push   %eax
     528:	e8 2c 3c 00 00       	call   4159 <printf>
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     ...
     53d:	68 9b 47 00 00       	push   $0x479b
     542:	50                   	push   %eax
     543:	e8 11 3c 00 00       	call   4159 <printf>
  ...
  if(unlink("small") < 0){
     ...
     55c:	68 bd 46 00 00       	push   $0x46bd
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     577:	68 ae 47 00 00       	push   $0x47ae
     57c:	50                   	push   %eax
     57d:	e8 d7 3b 00 00       	call   4159 <printf>
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     592:	68 bb 47 00 00       	push   $0x47bb
     597:	50                   	push   %eax
     598:	e8 bc 3b 00 00       	call   4159 <printf>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5ad:	68 d0 47 00 00       	push   $0x47d0
     5b2:	50                   	push   %eax
     5b3:	e8 a1 3b 00 00       	call   4159 <printf>
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     5cc:	68 e4 47 00 00       	push   $0x47e4
     5d1:	50                   	push   %eax
     5d2:	e8 82 3b 00 00       	call   4159 <printf>
     5d7:	83 c4 10             	add    $0x10,%esp

  fd = open("big", O_CREATE|O_RDWR);
     5da:	83 ec 08             	sub    $0x8,%esp
     5dd:	68 02 02 00 00       	push   $0x202
     5e2:	68 f4 47 00 00       	push   $0x47f4
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     600:	68 f8 47 00 00       	push   $0x47f8
     605:	50                   	push   %eax
     606:	e8 4e 3b 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     650:	68 12 48 00 00       	push   $0x4812
     655:	50                   	push   %eax
     656:	e8 fe 3a 00 00       	call   4159 <printf>
  ...
  fd = open("big", O_RDONLY);
     ...
     682:	6a 00                	push   $0x0
     684:	68 f4 47 00 00       	push   $0x47f4
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     6a2:	68 30 48 00 00       	push   $0x4830
     6a7:	50                   	push   %eax
     6a8:	e8 ac 3a 00 00       	call   4159 <printf>
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6f1:	68 49 48 00 00       	push   $0x4849
     6f6:	50                   	push   %eax
     6f7:	e8 5d 3a 00 00       	call   4159 <printf>
     ...
     718:	68 66 48 00 00       	push   $0x4866
     71d:	50                   	push   %eax
     71e:	e8 36 3a 00 00       	call   4159 <printf>
    ...
    if(((int*)buf)[0] != n){
     ...
     747:	68 78 48 00 00       	push   $0x4878
     74c:	50                   	push   %eax
     74d:	e8 07 3a 00 00       	call   4159 <printf>
  ...
  if(unlink("big") < 0){
     ...
     775:	68 f4 47 00 00       	push   $0x47f4
    ...
    printf(stdout, "unlink big failed\n");
     ...
     78e:	68 98 48 00 00       	push   $0x4898
     793:	50                   	push   %eax
     794:	e8 c0 39 00 00       	call   4159 <printf>
  ...
  printf(stdout, "big files ok\n");
     ...
     7a9:	68 ab 48 00 00       	push   $0x48ab
     7ae:	50                   	push   %eax
     7af:	e8 a5 39 00 00       	call   4159 <printf>
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     7c8:	68 bc 48 00 00       	push   $0x48bc
     7cd:	50                   	push   %eax
     7ce:	e8 86 39 00 00       	call   4159 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     86c:	68 e4 48 00 00       	push   $0x48e4
     871:	50                   	push   %eax
     872:	e8 e2 38 00 00       	call   4159 <printf>
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     88b:	68 0a 49 00 00       	push   $0x490a
     890:	50                   	push   %eax
     891:	e8 c3 38 00 00       	call   4159 <printf>
     896:	83 c4 10             	add    $0x10,%esp

  if(mkdir("dir0") < 0){
     899:	83 ec 0c             	sub    $0xc,%esp
     89c:	68 16 49 00 00       	push   $0x4916
    ...
    printf(stdout, "mkdir failed\n");
     ...
     8b5:	68 39 45 00 00       	push   $0x4539
     8ba:	50                   	push   %eax
     8bb:	e8 99 38 00 00       	call   4159 <printf>
  ...
  if(chdir("dir0") < 0){
     ...
     8cb:	68 16 49 00 00       	push   $0x4916
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     8e4:	68 1b 49 00 00       	push   $0x491b
     8e9:	50                   	push   %eax
     8ea:	e8 6a 38 00 00       	call   4159 <printf>
  ...
  if(chdir("..") < 0){
     ...
     8fa:	68 2e 49 00 00       	push   $0x492e
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     913:	68 31 49 00 00       	push   $0x4931
     918:	50                   	push   %eax
     919:	e8 3b 38 00 00       	call   4159 <printf>
  ...
  if(unlink("dir0") < 0){
     ...
     929:	68 16 49 00 00       	push   $0x4916
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     942:	68 42 49 00 00       	push   $0x4942
     947:	50                   	push   %eax
     948:	e8 0c 38 00 00       	call   4159 <printf>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     95d:	68 56 49 00 00       	push   $0x4956
     962:	50                   	push   %eax
     963:	e8 f1 37 00 00       	call   4159 <printf>
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     97c:	68 65 49 00 00       	push   $0x4965
     981:	50                   	push   %eax
     982:	e8 d2 37 00 00       	call   4159 <printf>
     987:	83 c4 10             	add    $0x10,%esp
  if(exec("echo", echoargv) < 0){
     98a:	83 ec 08             	sub    $0x8,%esp
     98d:	68 d8 63 00 00       	push   $0x63d8
     992:	68 10 45 00 00       	push   $0x4510
    ...
    printf(stdout, "exec echo failed\n");
     ...
     9ab:	68 70 49 00 00       	push   $0x4970
     9b0:	50                   	push   %eax
     9b1:	e8 a3 37 00 00       	call   4159 <printf>
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     ...
     9dd:	68 82 49 00 00       	push   $0x4982
     9e2:	6a 01                	push   $0x1
     9e4:	e8 70 37 00 00       	call   4159 <printf>
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a70:	68 91 49 00 00       	push   $0x4991
     a75:	6a 01                	push   $0x1
     a77:	e8 dd 36 00 00       	call   4159 <printf>
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ae8:	68 9f 49 00 00       	push   $0x499f
     aed:	6a 01                	push   $0x1
     aef:	e8 65 36 00 00       	call   4159 <printf>
    ...
    if(total != 5 * 1033){
     ...
     b55:	68 ad 49 00 00       	push   $0x49ad
     b5a:	6a 01                	push   $0x1
     b5c:	e8 f8 35 00 00       	call   4159 <printf>
  ...
  printf(1, "pipe1 ok\n");
     ...
     b80:	68 d3 49 00 00       	push   $0x49d3
     b85:	6a 01                	push   $0x1
     b87:	e8 cd 35 00 00       	call   4159 <printf>
    ...
    printf(1, "fork() failed\n");
     ...
     b94:	68 c4 49 00 00       	push   $0x49c4
     b99:	6a 01                	push   $0x1
     b9b:	e8 b9 35 00 00       	call   4159 <printf>
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     bb3:	68 dd 49 00 00       	push   $0x49dd
     bb8:	6a 01                	push   $0x1
     bba:	e8 9a 35 00 00       	call   4159 <printf>
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c14:	6a 01                	push   $0x1
     c16:	68 e7 49 00 00       	push   $0x49e7
     c1b:	50                   	push   %eax
     ...
     c2c:	68 e9 49 00 00       	push   $0x49e9
     c31:	6a 01                	push   $0x1
     c33:	e8 21 35 00 00       	call   4159 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     c7c:	68 fd 49 00 00       	push   $0x49fd
     c81:	6a 01                	push   $0x1
     c83:	e8 d1 34 00 00       	call   4159 <printf>
  ...
  printf(1, "kill... ");
     ...
     c9f:	68 10 4a 00 00       	push   $0x4a10
     ca4:	6a 01                	push   $0x1
     ca6:	e8 ae 34 00 00       	call   4159 <printf>
  ...
  printf(1, "wait... ");
     ...
     cdb:	68 19 4a 00 00       	push   $0x4a19
     ce0:	6a 01                	push   $0x1
     ce2:	e8 72 34 00 00       	call   4159 <printf>
  ...
  printf(1, "preempt ok\n");
     ...
     cfc:	68 22 4a 00 00       	push   $0x4a22
     d01:	6a 01                	push   $0x1
     d03:	e8 51 34 00 00       	call   4159 <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d2d:	68 b1 45 00 00       	push   $0x45b1
     d32:	6a 01                	push   $0x1
     d34:	e8 20 34 00 00       	call   4159 <printf>
    ...
    if(pid){
     ...
     d51:	68 2e 4a 00 00       	push   $0x4a2e
     d56:	6a 01                	push   $0x1
     d58:	e8 fc 33 00 00       	call   4159 <printf>
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     ...
     d74:	68 3e 4a 00 00       	push   $0x4a3e
     d79:	6a 01                	push   $0x1
     d7b:	e8 d9 33 00 00       	call   4159 <printf>
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     d8e:	68 4b 4a 00 00       	push   $0x4a4b
     d93:	6a 01                	push   $0x1
     d95:	e8 bf 33 00 00       	call   4159 <printf>
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     dd6:	e8 51 36 00 00       	call   442c <malloc>
    ...
    while(m1){
     ...
     df7:	e8 ee 34 00 00       	call   42ea <free>
    ...
    m1 = malloc(1024*20);
     ...
     e13:	e8 14 36 00 00       	call   442c <malloc>
    ...
    if(m1 == 0){
     ...
     e27:	68 55 4a 00 00       	push   $0x4a55
     e2c:	6a 01                	push   $0x1
     e2e:	e8 26 33 00 00       	call   4159 <printf>
    ...
    free(m1);
     ...
     e4f:	e8 96 34 00 00       	call   42ea <free>
     e54:	83 c4 10             	add    $0x10,%esp
    printf(1, "mem ok\n");
     e57:	83 ec 08             	sub    $0x8,%esp
     e5a:	68 6f 4a 00 00       	push   $0x4a6f
     e5f:	6a 01                	push   $0x1
     e61:	e8 f3 32 00 00       	call   4159 <printf>
...
sharedfd(void)
{
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     ebf:	68 90 4a 00 00       	push   $0x4a90
     ec4:	6a 01                	push   $0x1
     ec6:	e8 8e 32 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     f24:	68 bc 4a 00 00       	push   $0x4abc
     f29:	6a 01                	push   $0x1
     f2b:	e8 29 32 00 00       	call   4159 <printf>
  ...
  fd = open("sharedfd", 0);
     ...
     f63:	6a 00                	push   $0x0
     f65:	68 86 4a 00 00       	push   $0x4a86
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     f7e:	68 dc 4a 00 00       	push   $0x4adc
     f83:	6a 01                	push   $0x1
     f85:	e8 cf 31 00 00       	call   4159 <printf>
  ...
  unlink("sharedfd");
    ...
    100a:	68 86 4a 00 00       	push   $0x4a86
  ...
  if(nc == 10000 && np == 10000){
    ...
    102c:	68 07 4b 00 00       	push   $0x4b07
    1031:	6a 01                	push   $0x1
    1033:	e8 21 31 00 00       	call   4159 <printf>
    ...
    1043:	68 14 4b 00 00       	push   $0x4b14
    1048:	6a 01                	push   $0x1
    104a:	e8 0a 31 00 00       	call   4159 <printf>
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    105f:	c7 45 c8 29 4b 00 00 	movl   $0x4b29,-0x38(%ebp)
    1066:	c7 45 cc 2c 4b 00 00 	movl   $0x4b2c,-0x34(%ebp)
    106d:	c7 45 d0 2f 4b 00 00 	movl   $0x4b2f,-0x30(%ebp)
    1074:	c7 45 d4 32 4b 00 00 	movl   $0x4b32,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    107b:	83 ec 08             	sub    $0x8,%esp
    107e:	68 35 4b 00 00       	push   $0x4b35
    1083:	6a 01                	push   $0x1
    1085:	e8 cf 30 00 00       	call   4159 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    10c2:	68 b1 45 00 00       	push   $0x45b1
    10c7:	6a 01                	push   $0x1
    10c9:	e8 8b 30 00 00       	call   4159 <printf>
    ...
    10ff:	68 45 4b 00 00       	push   $0x4b45
    1104:	6a 01                	push   $0x1
    1106:	e8 4e 30 00 00       	call   4159 <printf>
    ...
    1162:	68 54 4b 00 00       	push   $0x4b54
    1167:	6a 01                	push   $0x1
    1169:	e8 eb 2f 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < 2; i++){
    ...
    1201:	68 65 4b 00 00       	push   $0x4b65
    1206:	6a 01                	push   $0x1
    1208:	e8 4c 2f 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < 2; i++){
    ...
    1265:	68 71 4b 00 00       	push   $0x4b71
    126a:	6a 01                	push   $0x1
    126c:	e8 e8 2e 00 00       	call   4159 <printf>
  ...
  printf(1, "fourfiles ok\n");
    ...
    1298:	68 82 4b 00 00       	push   $0x4b82
    129d:	6a 01                	push   $0x1
    129f:	e8 b5 2e 00 00       	call   4159 <printf>
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    12b3:	68 90 4b 00 00       	push   $0x4b90
    12b8:	6a 01                	push   $0x1
    12ba:	e8 9a 2e 00 00       	call   4159 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12df:	68 b1 45 00 00       	push   $0x45b1
    12e4:	6a 01                	push   $0x1
    12e6:	e8 6e 2e 00 00       	call   4159 <printf>
    ...
    133f:	68 45 4b 00 00       	push   $0x4b45
    1344:	6a 01                	push   $0x1
    1346:	e8 0e 2e 00 00       	call   4159 <printf>
    ...
    1399:	68 34 46 00 00       	push   $0x4634
    139e:	6a 01                	push   $0x1
    13a0:	e8 b4 2d 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < N; i++){
    ...
    144e:	50                   	push   %eax
    144f:	68 a4 4b 00 00       	push   $0x4ba4
    1454:	6a 01                	push   $0x1
    1456:	e8 fe 2c 00 00       	call   4159 <printf>
    ...
    147b:	50                   	push   %eax
    147c:	68 c8 4b 00 00       	push   $0x4bc8
    1481:	6a 01                	push   $0x1
    1483:	e8 d1 2c 00 00       	call   4159 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    150a:	68 e8 4b 00 00       	push   $0x4be8
    150f:	6a 01                	push   $0x1
    1511:	e8 43 2c 00 00       	call   4159 <printf>
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1525:	68 f9 4b 00 00       	push   $0x4bf9
    152a:	6a 01                	push   $0x1
    152c:	e8 28 2c 00 00       	call   4159 <printf>
    1531:	83 c4 10             	add    $0x10,%esp
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1534:	83 ec 08             	sub    $0x8,%esp
    1537:	68 02 02 00 00       	push   $0x202
    153c:	68 0a 4c 00 00       	push   $0x4c0a
  ...
  if(fd < 0){
    ...
    1555:	68 15 4c 00 00       	push   $0x4c15
    155a:	6a 01                	push   $0x1
    155c:	e8 f8 2b 00 00       	call   4159 <printf>
  ...
  write(fd, "hello", 5);
    ...
    156c:	6a 05                	push   $0x5
    156e:	68 2f 4c 00 00       	push   $0x4c2f
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    158f:	6a 02                	push   $0x2
    1591:	68 0a 4c 00 00       	push   $0x4c0a
  ...
  if(fd < 0){
    ...
    15aa:	68 35 4c 00 00       	push   $0x4c35
    15af:	6a 01                	push   $0x1
    15b1:	e8 a3 2b 00 00       	call   4159 <printf>
  ...
  if(unlink("unlinkread") != 0){
    ...
    15c1:	68 0a 4c 00 00       	push   $0x4c0a
    ...
    15d5:	68 4d 4c 00 00       	push   $0x4c4d
    15da:	6a 01                	push   $0x1
    15dc:	e8 78 2b 00 00       	call   4159 <printf>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    15f1:	68 0a 4c 00 00       	push   $0x4c0a
  ...
  write(fd1, "yyy", 3);
    ...
    1604:	6a 03                	push   $0x3
    1606:	68 67 4c 00 00       	push   $0x4c67
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1644:	68 6b 4c 00 00       	push   $0x4c6b
    1649:	6a 01                	push   $0x1
    164b:	e8 09 2b 00 00       	call   4159 <printf>
  ...
  if(buf[0] != 'h'){
    ...
    1666:	68 82 4c 00 00       	push   $0x4c82
    166b:	6a 01                	push   $0x1
    166d:	e8 e7 2a 00 00       	call   4159 <printf>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1697:	68 99 4c 00 00       	push   $0x4c99
    169c:	6a 01                	push   $0x1
    169e:	e8 b6 2a 00 00       	call   4159 <printf>
  ...
  unlink("unlinkread");
    ...
    16bc:	68 0a 4c 00 00       	push   $0x4c0a
    16c1:	e8 2c 29 00 00       	call   3ff2 <unlink>
    16c6:	83 c4 10             	add    $0x10,%esp
  printf(1, "unlinkread ok\n");
    16c9:	83 ec 08             	sub    $0x8,%esp
    16cc:	68 b2 4c 00 00       	push   $0x4cb2
    16d1:	6a 01                	push   $0x1
    16d3:	e8 81 2a 00 00       	call   4159 <printf>
...
linktest(void)
{
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    171e:	68 cb 4c 00 00       	push   $0x4ccb
  ...
  if(fd < 0){
    ...
    1737:	68 d3 4c 00 00       	push   $0x4cd3
    173c:	6a 01                	push   $0x1
    173e:	e8 16 2a 00 00       	call   4159 <printf>
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    174e:	6a 05                	push   $0x5
    1750:	68 2f 4c 00 00       	push   $0x4c2f
    ...
    1768:	68 e6 4c 00 00       	push   $0x4ce6
    176d:	6a 01                	push   $0x1
    176f:	e8 e5 29 00 00       	call   4159 <printf>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    178d:	68 cf 4c 00 00       	push   $0x4ccf
    1792:	68 cb 4c 00 00       	push   $0x4ccb
    ...
    17a6:	68 f8 4c 00 00       	push   $0x4cf8
    17ab:	6a 01                	push   $0x1
    17ad:	e8 a7 29 00 00       	call   4159 <printf>
  ...
  unlink("lf1");
    ...
    17bd:	68 cb 4c 00 00       	push   $0x4ccb
  ...
  if(open("lf1", 0) >= 0){
    ...
    17cd:	6a 00                	push   $0x0
    17cf:	68 cb 4c 00 00       	push   $0x4ccb
    ...
    17e3:	68 10 4d 00 00       	push   $0x4d10
    17e8:	6a 01                	push   $0x1
    17ea:	e8 6a 29 00 00       	call   4159 <printf>
  ...
  fd = open("lf2", 0);
    ...
    17fa:	6a 00                	push   $0x0
    17fc:	68 cf 4c 00 00       	push   $0x4ccf
  ...
  if(fd < 0){
    ...
    1815:	68 35 4d 00 00       	push   $0x4d35
    181a:	6a 01                	push   $0x1
    181c:	e8 38 29 00 00       	call   4159 <printf>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1849:	68 46 4d 00 00       	push   $0x4d46
    184e:	6a 01                	push   $0x1
    1850:	e8 04 29 00 00       	call   4159 <printf>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    186e:	68 cf 4c 00 00       	push   $0x4ccf
    1873:	68 cf 4c 00 00       	push   $0x4ccf
    ...
    1887:	68 57 4d 00 00       	push   $0x4d57
    188c:	6a 01                	push   $0x1
    188e:	e8 c6 28 00 00       	call   4159 <printf>
  ...
  unlink("lf2");
    ...
    189e:	68 cf 4c 00 00       	push   $0x4ccf
    18a3:	e8 4a 27 00 00       	call   3ff2 <unlink>
    18a8:	83 c4 10             	add    $0x10,%esp
  if(link("lf2", "lf1") >= 0){
    18ab:	83 ec 08             	sub    $0x8,%esp
    18ae:	68 cb 4c 00 00       	push   $0x4ccb
    18b3:	68 cf 4c 00 00       	push   $0x4ccf
    ...
    18c7:	68 78 4d 00 00       	push   $0x4d78
    18cc:	6a 01                	push   $0x1
    18ce:	e8 86 28 00 00       	call   4159 <printf>
  ...
  if(link(".", "lf1") >= 0){
    ...
    18de:	68 cb 4c 00 00       	push   $0x4ccb
    18e3:	68 9b 4d 00 00       	push   $0x4d9b
    ...
    18fc:	6a 01                	push   $0x1
    18fe:	e8 56 28 00 00       	call   4159 <printf>
  ...
  printf(1, "linktest ok\n");
    ...
    190e:	68 b9 4d 00 00       	push   $0x4db9
    1913:	6a 01                	push   $0x1
    1915:	e8 3f 28 00 00       	call   4159 <printf>
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    1929:	68 c6 4d 00 00       	push   $0x4dc6
    192e:	6a 01                	push   $0x1
    1930:	e8 24 28 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < 40; i++){
    ...
    199a:	50                   	push   %eax
    199b:	68 d6 4d 00 00       	push   $0x4dd6
    ...
    19de:	50                   	push   %eax
    19df:	68 d6 4d 00 00       	push   $0x4dd6
    ...
    1a11:	50                   	push   %eax
    1a12:	68 d9 4d 00 00       	push   $0x4dd9
    1a17:	6a 01                	push   $0x1
    1a19:	e8 3b 27 00 00       	call   4159 <printf>
  ...
  fd = open(".", 0);
    ...
    1a68:	6a 00                	push   $0x0
    1a6a:	68 9b 4d 00 00       	push   $0x4d9b
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1ac8:	50                   	push   %eax
    1ac9:	68 f5 4d 00 00       	push   $0x4df5
    1ace:	6a 01                	push   $0x1
    1ad0:	e8 84 26 00 00       	call   4159 <printf>
    ...
    1af5:	50                   	push   %eax
    1af6:	68 0e 4e 00 00       	push   $0x4e0e
    1afb:	6a 01                	push   $0x1
    1afd:	e8 57 26 00 00       	call   4159 <printf>
  ...
  if(n != 40){
    ...
    1b4c:	68 2c 4e 00 00       	push   $0x4e2c
    1b51:	6a 01                	push   $0x1
    1b53:	e8 01 26 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < 40; i++){
    ...
    1b86:	68 b1 45 00 00       	push   $0x45b1
    1b8b:	6a 01                	push   $0x1
    1b8d:	e8 c7 25 00 00       	call   4159 <printf>
  ...
  printf(1, "concreate ok\n");
    ...
    1cbe:	68 5d 4e 00 00       	push   $0x4e5d
    1cc3:	6a 01                	push   $0x1
    1cc5:	e8 8f 24 00 00       	call   4159 <printf>
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1cd9:	68 6b 4e 00 00       	push   $0x4e6b
    1cde:	6a 01                	push   $0x1
    1ce0:	e8 74 24 00 00       	call   4159 <printf>
    1ce5:	83 c4 10             	add    $0x10,%esp

  unlink("x");
    1ce8:	83 ec 0c             	sub    $0xc,%esp
    1ceb:	68 e7 49 00 00       	push   $0x49e7
  ...
  if(pid < 0){
    ...
    1d09:	68 b1 45 00 00       	push   $0x45b1
    1d0e:	6a 01                	push   $0x1
    1d10:	e8 44 24 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < 100; i++){
    ...
    1d75:	68 e7 49 00 00       	push   $0x49e7
    ...
    1db0:	68 e7 49 00 00       	push   $0x49e7
    1db5:	68 7c 4e 00 00       	push   $0x4e7c
    ...
    1dc7:	68 e7 49 00 00       	push   $0x49e7
  ...
  printf(1, "linkunlink ok\n");
    ...
    1df7:	68 80 4e 00 00       	push   $0x4e80
    1dfc:	6a 01                	push   $0x1
    1dfe:	e8 56 23 00 00       	call   4159 <printf>
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    ...
    1e12:	68 8f 4e 00 00       	push   $0x4e8f
    1e17:	6a 01                	push   $0x1
    1e19:	e8 3b 23 00 00       	call   4159 <printf>
    1e1e:	83 c4 10             	add    $0x10,%esp
  unlink("bd");
    1e21:	83 ec 0c             	sub    $0xc,%esp
    1e24:	68 9c 4e 00 00       	push   $0x4e9c
  ...
  fd = open("bd", O_CREATE);
    ...
    1e39:	68 9c 4e 00 00       	push   $0x4e9c
  ...
  if(fd < 0){
    ...
    1e52:	68 9f 4e 00 00       	push   $0x4e9f
    1e57:	6a 01                	push   $0x1
    1e59:	e8 fb 22 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < 500; i++){
    ...
    1eb3:	50                   	push   %eax
    1eb4:	68 9c 4e 00 00       	push   $0x4e9c
    ...
    1ec8:	68 b5 4e 00 00       	push   $0x4eb5
    1ecd:	6a 01                	push   $0x1
    1ecf:	e8 85 22 00 00       	call   4159 <printf>
  ...
  unlink("bd");
    ...
    1eec:	68 9c 4e 00 00       	push   $0x4e9c
  ...
  for(i = 0; i < 500; i++){
    ...
    1f48:	68 c9 4e 00 00       	push   $0x4ec9
    1f4d:	6a 01                	push   $0x1
    1f4f:	e8 05 22 00 00       	call   4159 <printf>
  ...
  printf(1, "bigdir ok\n");
    ...
    1f6c:	68 de 4e 00 00       	push   $0x4ede
    1f71:	6a 01                	push   $0x1
    1f73:	e8 e1 21 00 00       	call   4159 <printf>
...
subdir(void)
{
  ...
  if(mkdir("dd") != 0){
    ...
    1fbd:	68 fc 4e 00 00       	push   $0x4efc
    1fc2:	6a 01                	push   $0x1
    1fc4:	e8 90 21 00 00       	call   4159 <printf>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fd9:	68 14 4f 00 00       	push   $0x4f14
  ...
  if(fd < 0){
    ...
    1ff2:	68 1a 4f 00 00       	push   $0x4f1a
    1ff7:	6a 01                	push   $0x1
    1ff9:	e8 5b 21 00 00       	call   4159 <printf>
  ...
  write(fd, "ff", 2);
    ...
    2009:	6a 02                	push   $0x2
    200b:	68 f6 4e 00 00       	push   $0x4ef6
  ...
  if(unlink("dd") >= 0){
    ...
    202c:	68 f9 4e 00 00       	push   $0x4ef9
    ...
    2040:	68 30 4f 00 00       	push   $0x4f30
    2045:	6a 01                	push   $0x1
    2047:	e8 0d 21 00 00       	call   4159 <printf>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2057:	68 56 4f 00 00       	push   $0x4f56
    ...
    206b:	68 5d 4f 00 00       	push   $0x4f5d
    2070:	6a 01                	push   $0x1
    2072:	e8 e2 20 00 00       	call   4159 <printf>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2087:	68 78 4f 00 00       	push   $0x4f78
  ...
  if(fd < 0){
    ...
    20a0:	68 81 4f 00 00       	push   $0x4f81
    20a5:	6a 01                	push   $0x1
    20a7:	e8 ad 20 00 00       	call   4159 <printf>
  ...
  write(fd, "FF", 2);
    ...
    20b7:	6a 02                	push   $0x2
    20b9:	68 99 4f 00 00       	push   $0x4f99
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20da:	6a 00                	push   $0x0
    20dc:	68 9c 4f 00 00       	push   $0x4f9c
  ...
  if(fd < 0){
    ...
    20f5:	68 a8 4f 00 00       	push   $0x4fa8
    20fa:	6a 01                	push   $0x1
    20fc:	e8 58 20 00 00       	call   4159 <printf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2138:	68 c1 4f 00 00       	push   $0x4fc1
    213d:	6a 01                	push   $0x1
    213f:	e8 15 20 00 00       	call   4159 <printf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    215d:	68 dc 4f 00 00       	push   $0x4fdc
    2162:	68 78 4f 00 00       	push   $0x4f78
    ...
    2176:	68 e8 4f 00 00       	push   $0x4fe8
    217b:	6a 01                	push   $0x1
    217d:	e8 d7 1f 00 00       	call   4159 <printf>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    218d:	68 78 4f 00 00       	push   $0x4f78
    ...
    21a1:	68 09 50 00 00       	push   $0x5009
    21a6:	6a 01                	push   $0x1
    21a8:	e8 ac 1f 00 00       	call   4159 <printf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    21b8:	6a 00                	push   $0x0
    21ba:	68 78 4f 00 00       	push   $0x4f78
    ...
    21ce:	68 24 50 00 00       	push   $0x5024
    21d3:	6a 01                	push   $0x1
    21d5:	e8 7f 1f 00 00       	call   4159 <printf>
  ...
  if(chdir("dd") != 0){
    ...
    21e5:	68 f9 4e 00 00       	push   $0x4ef9
    ...
    21f9:	68 48 50 00 00       	push   $0x5048
    21fe:	6a 01                	push   $0x1
    2200:	e8 54 1f 00 00       	call   4159 <printf>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2210:	68 59 50 00 00       	push   $0x5059
    ...
    2224:	68 65 50 00 00       	push   $0x5065
    2229:	6a 01                	push   $0x1
    222b:	e8 29 1f 00 00       	call   4159 <printf>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    223b:	68 7f 50 00 00       	push   $0x507f
    ...
    224f:	68 65 50 00 00       	push   $0x5065
    2254:	6a 01                	push   $0x1
    2256:	e8 fe 1e 00 00       	call   4159 <printf>
  ...
  if(chdir("./..") != 0){
    ...
    2266:	68 8e 50 00 00       	push   $0x508e
    ...
    227a:	68 93 50 00 00       	push   $0x5093
    227f:	6a 01                	push   $0x1
    2281:	e8 d3 1e 00 00       	call   4159 <printf>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2291:	6a 00                	push   $0x0
    2293:	68 dc 4f 00 00       	push   $0x4fdc
  ...
  if(fd < 0){
    ...
    22ac:	68 a6 50 00 00       	push   $0x50a6
    22b1:	6a 01                	push   $0x1
    22b3:	e8 a1 1e 00 00       	call   4159 <printf>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22e0:	68 be 50 00 00       	push   $0x50be
    22e5:	6a 01                	push   $0x1
    22e7:	e8 6d 1e 00 00       	call   4159 <printf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2305:	6a 00                	push   $0x0
    2307:	68 78 4f 00 00       	push   $0x4f78
    ...
    231b:	68 dc 50 00 00       	push   $0x50dc
    2320:	6a 01                	push   $0x1
    2322:	e8 32 1e 00 00       	call   4159 <printf>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2337:	68 01 51 00 00       	push   $0x5101
    ...
    234b:	68 0a 51 00 00       	push   $0x510a
    2350:	6a 01                	push   $0x1
    2352:	e8 02 1e 00 00       	call   4159 <printf>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2367:	68 26 51 00 00       	push   $0x5126
    ...
    237b:	68 2f 51 00 00       	push   $0x512f
    2380:	6a 01                	push   $0x1
    2382:	e8 d2 1d 00 00       	call   4159 <printf>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2397:	68 f9 4e 00 00       	push   $0x4ef9
    ...
    23ab:	68 4b 51 00 00       	push   $0x514b
    23b0:	6a 01                	push   $0x1
    23b2:	e8 a2 1d 00 00       	call   4159 <printf>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    23c2:	6a 02                	push   $0x2
    23c4:	68 f9 4e 00 00       	push   $0x4ef9
    ...
    23d8:	68 61 51 00 00       	push   $0x5161
    23dd:	6a 01                	push   $0x1
    23df:	e8 75 1d 00 00       	call   4159 <printf>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    23ef:	6a 01                	push   $0x1
    23f1:	68 f9 4e 00 00       	push   $0x4ef9
    ...
    2405:	68 7a 51 00 00       	push   $0x517a
    240a:	6a 01                	push   $0x1
    240c:	e8 48 1d 00 00       	call   4159 <printf>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    241c:	68 95 51 00 00       	push   $0x5195
    2421:	68 01 51 00 00       	push   $0x5101
    ...
    2435:	68 a0 51 00 00       	push   $0x51a0
    243a:	6a 01                	push   $0x1
    243c:	e8 18 1d 00 00       	call   4159 <printf>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    244c:	68 95 51 00 00       	push   $0x5195
    2451:	68 26 51 00 00       	push   $0x5126
    ...
    2465:	68 c4 51 00 00       	push   $0x51c4
    246a:	6a 01                	push   $0x1
    246c:	e8 e8 1c 00 00       	call   4159 <printf>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    247c:	68 dc 4f 00 00       	push   $0x4fdc
    2481:	68 14 4f 00 00       	push   $0x4f14
    ...
    2495:	68 e8 51 00 00       	push   $0x51e8
    249a:	6a 01                	push   $0x1
    249c:	e8 b8 1c 00 00       	call   4159 <printf>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    24ac:	68 01 51 00 00       	push   $0x5101
    ...
    24c0:	68 0a 52 00 00       	push   $0x520a
    24c5:	6a 01                	push   $0x1
    24c7:	e8 8d 1c 00 00       	call   4159 <printf>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    24d7:	68 26 51 00 00       	push   $0x5126
    ...
    24eb:	68 25 52 00 00       	push   $0x5225
    24f0:	6a 01                	push   $0x1
    24f2:	e8 62 1c 00 00       	call   4159 <printf>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2502:	68 dc 4f 00 00       	push   $0x4fdc
    ...
    2516:	68 40 52 00 00       	push   $0x5240
    251b:	6a 01                	push   $0x1
    251d:	e8 37 1c 00 00       	call   4159 <printf>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    252d:	68 26 51 00 00       	push   $0x5126
    ...
    2541:	68 5d 52 00 00       	push   $0x525d
    2546:	6a 01                	push   $0x1
    2548:	e8 0c 1c 00 00       	call   4159 <printf>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2558:	68 01 51 00 00       	push   $0x5101
    ...
    256c:	68 79 52 00 00       	push   $0x5279
    2571:	6a 01                	push   $0x1
    2573:	e8 e1 1b 00 00       	call   4159 <printf>
  ...
  if(chdir("dd/ff") == 0){
    ...
    2583:	68 14 4f 00 00       	push   $0x4f14
    ...
    2597:	68 95 52 00 00       	push   $0x5295
    259c:	6a 01                	push   $0x1
    259e:	e8 b6 1b 00 00       	call   4159 <printf>
  ...
  if(chdir("dd/xx") == 0){
    ...
    25ae:	68 ad 52 00 00       	push   $0x52ad
    ...
    25c2:	68 b3 52 00 00       	push   $0x52b3
    25c7:	6a 01                	push   $0x1
    25c9:	e8 8b 1b 00 00       	call   4159 <printf>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    25d9:	68 dc 4f 00 00       	push   $0x4fdc
    ...
    25ed:	68 09 50 00 00       	push   $0x5009
    25f2:	6a 01                	push   $0x1
    25f4:	e8 60 1b 00 00       	call   4159 <printf>
  ...
  if(unlink("dd/ff") != 0){
    ...
    2604:	68 14 4f 00 00       	push   $0x4f14
    ...
    2618:	68 cb 52 00 00       	push   $0x52cb
    261d:	6a 01                	push   $0x1
    261f:	e8 35 1b 00 00       	call   4159 <printf>
  ...
  if(unlink("dd") == 0){
    ...
    262f:	68 f9 4e 00 00       	push   $0x4ef9
    ...
    2643:	68 e0 52 00 00       	push   $0x52e0
    2648:	6a 01                	push   $0x1
    264a:	e8 0a 1b 00 00       	call   4159 <printf>
  ...
  if(unlink("dd/dd") < 0){
    ...
    265a:	68 00 53 00 00       	push   $0x5300
    ...
    266e:	68 06 53 00 00       	push   $0x5306
    2673:	6a 01                	push   $0x1
    2675:	e8 df 1a 00 00       	call   4159 <printf>
  ...
  if(unlink("dd") < 0){
    ...
    2685:	68 f9 4e 00 00       	push   $0x4ef9
    ...
    2699:	68 1b 53 00 00       	push   $0x531b
    269e:	6a 01                	push   $0x1
    26a0:	e8 b4 1a 00 00       	call   4159 <printf>
  ...
  printf(1, "subdir ok\n");
    ...
    26b0:	68 2d 53 00 00       	push   $0x532d
    26b5:	6a 01                	push   $0x1
    26b7:	e8 9d 1a 00 00       	call   4159 <printf>
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    26cb:	68 38 53 00 00       	push   $0x5338
    26d0:	6a 01                	push   $0x1
    26d2:	e8 82 1a 00 00       	call   4159 <printf>
    26d7:	83 c4 10             	add    $0x10,%esp

  unlink("bigwrite");
    26da:	83 ec 0c             	sub    $0xc,%esp
    26dd:	68 47 53 00 00       	push   $0x5347
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26fe:	68 47 53 00 00       	push   $0x5347
    ...
    2717:	68 50 53 00 00       	push   $0x5350
    271c:	6a 01                	push   $0x1
    271e:	e8 36 1a 00 00       	call   4159 <printf>
    ...
    275b:	68 68 53 00 00       	push   $0x5368
    2760:	6a 01                	push   $0x1
    2762:	e8 f2 19 00 00       	call   4159 <printf>
    ...
    278a:	68 47 53 00 00       	push   $0x5347
  ...
  printf(1, "bigwrite ok\n");
    ...
    27ae:	68 7a 53 00 00       	push   $0x537a
    27b3:	6a 01                	push   $0x1
    27b5:	e8 9f 19 00 00       	call   4159 <printf>
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    ...
    27c9:	68 87 53 00 00       	push   $0x5387
    27ce:	6a 01                	push   $0x1
    27d0:	e8 84 19 00 00       	call   4159 <printf>
    27d5:	83 c4 10             	add    $0x10,%esp

  unlink("bigfile");
    27d8:	83 ec 0c             	sub    $0xc,%esp
    27db:	68 95 53 00 00       	push   $0x5395
  ...
  fd = open("bigfile", O_CREATE | O_RDWR);
    ...
    27f0:	68 95 53 00 00       	push   $0x5395
  ...
  if(fd < 0){
    ...
    2809:	68 9d 53 00 00       	push   $0x539d
    280e:	6a 01                	push   $0x1
    2810:	e8 44 19 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < 20; i++){
    ...
    2860:	68 b3 53 00 00       	push   $0x53b3
    2865:	6a 01                	push   $0x1
    2867:	e8 ed 18 00 00       	call   4159 <printf>
  ...
  fd = open("bigfile", 0);
    ...
    288f:	6a 00                	push   $0x0
    2891:	68 95 53 00 00       	push   $0x5395
  ...
  if(fd < 0){
    ...
    28aa:	68 c9 53 00 00       	push   $0x53c9
    28af:	6a 01                	push   $0x1
    28b1:	e8 a3 18 00 00       	call   4159 <printf>
  ...
  for(i = 0; ; i++){
    ...
    28f0:	68 de 53 00 00       	push   $0x53de
    28f5:	6a 01                	push   $0x1
    28f7:	e8 5d 18 00 00       	call   4159 <printf>
    ...
    2916:	68 f3 53 00 00       	push   $0x53f3
    291b:	6a 01                	push   $0x1
    291d:	e8 37 18 00 00       	call   4159 <printf>
    ...
    2961:	68 07 54 00 00       	push   $0x5407
    2966:	6a 01                	push   $0x1
    2968:	e8 ec 17 00 00       	call   4159 <printf>
  ...
  if(total != 20*600){
    ...
    299f:	68 20 54 00 00       	push   $0x5420
    29a4:	6a 01                	push   $0x1
    29a6:	e8 ae 17 00 00       	call   4159 <printf>
  ...
  unlink("bigfile");
    ...
    29b6:	68 95 53 00 00       	push   $0x5395
    29bb:	e8 32 16 00 00       	call   3ff2 <unlink>
    29c0:	83 c4 10             	add    $0x10,%esp

  printf(1, "bigfile test ok\n");
    29c3:	83 ec 08             	sub    $0x8,%esp
    29c6:	68 3a 54 00 00       	push   $0x543a
    29cb:	6a 01                	push   $0x1
    29cd:	e8 87 17 00 00       	call   4159 <printf>
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    29e1:	68 4b 54 00 00       	push   $0x544b
    29e6:	6a 01                	push   $0x1
    29e8:	e8 6c 17 00 00       	call   4159 <printf>
    29ed:	83 c4 10             	add    $0x10,%esp

  if(mkdir("12345678901234") != 0){
    29f0:	83 ec 0c             	sub    $0xc,%esp
    29f3:	68 5a 54 00 00       	push   $0x545a
    ...
    2a07:	68 69 54 00 00       	push   $0x5469
    2a0c:	6a 01                	push   $0x1
    2a0e:	e8 46 17 00 00       	call   4159 <printf>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2a1e:	68 88 54 00 00       	push   $0x5488
    ...
    2a32:	68 a8 54 00 00       	push   $0x54a8
    2a37:	6a 01                	push   $0x1
    2a39:	e8 1b 17 00 00       	call   4159 <printf>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a4e:	68 d8 54 00 00       	push   $0x54d8
  ...
  if(fd < 0){
    ...
    2a67:	68 08 55 00 00       	push   $0x5508
    2a6c:	6a 01                	push   $0x1
    2a6e:	e8 e6 16 00 00       	call   4159 <printf>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a8c:	6a 00                	push   $0x0
    2a8e:	68 48 55 00 00       	push   $0x5548
  ...
  if(fd < 0){
    ...
    2aa7:	68 78 55 00 00       	push   $0x5578
    2aac:	6a 01                	push   $0x1
    2aae:	e8 a6 16 00 00       	call   4159 <printf>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2acc:	68 b2 55 00 00       	push   $0x55b2
    ...
    2ae0:	68 d0 55 00 00       	push   $0x55d0
    2ae5:	6a 01                	push   $0x1
    2ae7:	e8 6d 16 00 00       	call   4159 <printf>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2af7:	68 00 56 00 00       	push   $0x5600
    ...
    2b0b:	68 20 56 00 00       	push   $0x5620
    2b10:	6a 01                	push   $0x1
    2b12:	e8 42 16 00 00       	call   4159 <printf>
  ...
  printf(1, "fourteen ok\n");
    ...
    2b22:	68 51 56 00 00       	push   $0x5651
    2b27:	6a 01                	push   $0x1
    2b29:	e8 2b 16 00 00       	call   4159 <printf>
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    ...
    2b3d:	68 5e 56 00 00       	push   $0x565e
    2b42:	6a 01                	push   $0x1
    2b44:	e8 10 16 00 00       	call   4159 <printf>
    2b49:	83 c4 10             	add    $0x10,%esp
  if(mkdir("dots") != 0){
    2b4c:	83 ec 0c             	sub    $0xc,%esp
    2b4f:	68 6a 56 00 00       	push   $0x566a
    ...
    2b63:	68 6f 56 00 00       	push   $0x566f
    2b68:	6a 01                	push   $0x1
    2b6a:	e8 ea 15 00 00       	call   4159 <printf>
  ...
  if(chdir("dots") != 0){
    ...
    2b7a:	68 6a 56 00 00       	push   $0x566a
    ...
    2b8e:	68 82 56 00 00       	push   $0x5682
    2b93:	6a 01                	push   $0x1
    2b95:	e8 bf 15 00 00       	call   4159 <printf>
  ...
  if(unlink(".") == 0){
    ...
    2ba5:	68 9b 4d 00 00       	push   $0x4d9b
    ...
    2bb9:	68 95 56 00 00       	push   $0x5695
    2bbe:	6a 01                	push   $0x1
    2bc0:	e8 94 15 00 00       	call   4159 <printf>
  ...
  if(unlink("..") == 0){
    ...
    2bd0:	68 2e 49 00 00       	push   $0x492e
    ...
    2be4:	68 a3 56 00 00       	push   $0x56a3
    2be9:	6a 01                	push   $0x1
    2beb:	e8 69 15 00 00       	call   4159 <printf>
  ...
  if(chdir("/") != 0){
    ...
    2bfb:	68 82 45 00 00       	push   $0x4582
    ...
    2c0f:	68 84 45 00 00       	push   $0x4584
    2c14:	6a 01                	push   $0x1
    2c16:	e8 3e 15 00 00       	call   4159 <printf>
  ...
  if(unlink("dots/.") == 0){
    ...
    2c26:	68 b2 56 00 00       	push   $0x56b2
    ...
    2c3a:	68 b9 56 00 00       	push   $0x56b9
    2c3f:	6a 01                	push   $0x1
    2c41:	e8 13 15 00 00       	call   4159 <printf>
  ...
  if(unlink("dots/..") == 0){
    ...
    2c51:	68 d0 56 00 00       	push   $0x56d0
    ...
    2c65:	68 d8 56 00 00       	push   $0x56d8
    2c6a:	6a 01                	push   $0x1
    2c6c:	e8 e8 14 00 00       	call   4159 <printf>
  ...
  if(unlink("dots") != 0){
    ...
    2c7c:	68 6a 56 00 00       	push   $0x566a
    ...
    2c90:	68 f0 56 00 00       	push   $0x56f0
    2c95:	6a 01                	push   $0x1
    2c97:	e8 bd 14 00 00       	call   4159 <printf>
  ...
  printf(1, "rmdot ok\n");
    ...
    2ca7:	68 05 57 00 00       	push   $0x5705
    2cac:	6a 01                	push   $0x1
    2cae:	e8 a6 14 00 00       	call   4159 <printf>
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    ...
    2cc2:	68 0f 57 00 00       	push   $0x570f
    2cc7:	6a 01                	push   $0x1
    2cc9:	e8 8b 14 00 00       	call   4159 <printf>
    2cce:	83 c4 10             	add    $0x10,%esp

  fd = open("dirfile", O_CREATE);
    2cd1:	83 ec 08             	sub    $0x8,%esp
    2cd4:	68 00 02 00 00       	push   $0x200
    2cd9:	68 1c 57 00 00       	push   $0x571c
  ...
  if(fd < 0){
    ...
    2cf2:	68 24 57 00 00       	push   $0x5724
    2cf7:	6a 01                	push   $0x1
    2cf9:	e8 5b 14 00 00       	call   4159 <printf>
  ...
  if(chdir("dirfile") == 0){
    ...
    2d17:	68 1c 57 00 00       	push   $0x571c
    ...
    2d2b:	68 3b 57 00 00       	push   $0x573b
    2d30:	6a 01                	push   $0x1
    2d32:	e8 22 14 00 00       	call   4159 <printf>
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d42:	6a 00                	push   $0x0
    2d44:	68 55 57 00 00       	push   $0x5755
  ...
  if(fd >= 0){
    ...
    2d5d:	68 60 57 00 00       	push   $0x5760
    2d62:	6a 01                	push   $0x1
    2d64:	e8 f0 13 00 00       	call   4159 <printf>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d79:	68 55 57 00 00       	push   $0x5755
  ...
  if(fd >= 0){
    ...
    2d92:	68 60 57 00 00       	push   $0x5760
    2d97:	6a 01                	push   $0x1
    2d99:	e8 bb 13 00 00       	call   4159 <printf>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2da9:	68 55 57 00 00       	push   $0x5755
    ...
    2dbd:	68 7e 57 00 00       	push   $0x577e
    2dc2:	6a 01                	push   $0x1
    2dc4:	e8 90 13 00 00       	call   4159 <printf>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2dd4:	68 55 57 00 00       	push   $0x5755
    ...
    2de8:	68 9b 57 00 00       	push   $0x579b
    2ded:	6a 01                	push   $0x1
    2def:	e8 65 13 00 00       	call   4159 <printf>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2dff:	68 55 57 00 00       	push   $0x5755
    2e04:	68 b9 57 00 00       	push   $0x57b9
    ...
    2e18:	68 c0 57 00 00       	push   $0x57c0
    2e1d:	6a 01                	push   $0x1
    2e1f:	e8 35 13 00 00       	call   4159 <printf>
  ...
  if(unlink("dirfile") != 0){
    ...
    2e2f:	68 1c 57 00 00       	push   $0x571c
    ...
    2e43:	68 df 57 00 00       	push   $0x57df
    2e48:	6a 01                	push   $0x1
    2e4a:	e8 0a 13 00 00       	call   4159 <printf>
  ...
  fd = open(".", O_RDWR);
    ...
    2e5a:	6a 02                	push   $0x2
    2e5c:	68 9b 4d 00 00       	push   $0x4d9b
  ...
  if(fd >= 0){
    ...
    2e75:	68 f8 57 00 00       	push   $0x57f8
    2e7a:	6a 01                	push   $0x1
    2e7c:	e8 d8 12 00 00       	call   4159 <printf>
  ...
  fd = open(".", 0);
    ...
    2e8c:	6a 00                	push   $0x0
    2e8e:	68 9b 4d 00 00       	push   $0x4d9b
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2ea1:	6a 01                	push   $0x1
    2ea3:	68 e7 49 00 00       	push   $0x49e7
    ...
    2eba:	68 17 58 00 00       	push   $0x5817
    2ebf:	6a 01                	push   $0x1
    2ec1:	e8 93 12 00 00       	call   4159 <printf>
  ...
  printf(1, "dir vs file OK\n");
    ...
    2edf:	68 2b 58 00 00       	push   $0x582b
    2ee4:	6a 01                	push   $0x1
    2ee6:	e8 6e 12 00 00       	call   4159 <printf>
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    2efa:	68 3b 58 00 00       	push   $0x583b
    2eff:	6a 01                	push   $0x1
    2f01:	e8 53 12 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2f18:	68 4c 58 00 00       	push   $0x584c
    ...
    2f2c:	68 52 58 00 00       	push   $0x5852
    2f31:	6a 01                	push   $0x1
    2f33:	e8 21 12 00 00       	call   4159 <printf>
    ...
    2f43:	68 4c 58 00 00       	push   $0x584c
    ...
    2f57:	68 66 58 00 00       	push   $0x5866
    2f5c:	6a 01                	push   $0x1
    2f5e:	e8 f6 11 00 00       	call   4159 <printf>
    ...
    2fc4:	68 7b 58 00 00       	push   $0x587b
    ...
    2feb:	68 7b 58 00 00       	push   $0x587b
  ...
  chdir("/");
    ...
    3009:	68 82 45 00 00       	push   $0x4582
    300e:	e8 ff 0f 00 00       	call   4012 <chdir>
    3013:	83 c4 10             	add    $0x10,%esp
  printf(1, "empty file name OK\n");
    3016:	83 ec 08             	sub    $0x8,%esp
    3019:	68 7e 58 00 00       	push   $0x587e
    301e:	6a 01                	push   $0x1
    3020:	e8 34 11 00 00       	call   4159 <printf>
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    3034:	68 92 58 00 00       	push   $0x5892
    3039:	6a 01                	push   $0x1
    303b:	e8 19 11 00 00       	call   4159 <printf>
    ...
    3060:	e8 3d 0f 00 00       	call   3fa2 <exit>
{
  ...
  if(n == 1000){
    ...
    3081:	68 a0 58 00 00       	push   $0x58a0
    3086:	6a 01                	push   $0x1
    3088:	e8 cc 10 00 00       	call   4159 <printf>
  ...
  for(; n > 0; n--){
    ...
    30a1:	68 c2 58 00 00       	push   $0x58c2
    30a6:	6a 01                	push   $0x1
    30a8:	e8 ac 10 00 00       	call   4159 <printf>
  ...
  if(wait() != -1){
    ...
    30cc:	68 d6 58 00 00       	push   $0x58d6
    30d1:	6a 01                	push   $0x1
    30d3:	e8 81 10 00 00       	call   4159 <printf>
  ...
  printf(1, "fork test OK\n");
    ...
    30e3:	68 e9 58 00 00       	push   $0x58e9
    30e8:	6a 01                	push   $0x1
    30ea:	e8 6a 10 00 00       	call   4159 <printf>
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    3104:	68 f7 58 00 00       	push   $0x58f7
    3109:	50                   	push   %eax
    310a:	e8 4a 10 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    3164:	68 02 59 00 00       	push   $0x5902
    3169:	50                   	push   %eax
    316a:	e8 ea 0f 00 00       	call   4159 <printf>
  ...
  if(pid < 0){
    ...
    31a9:	68 1d 59 00 00       	push   $0x591d
    31ae:	50                   	push   %eax
    31af:	e8 a5 0f 00 00       	call   4159 <printf>
  ...
  if(c != a + 1){
    ...
    31ef:	68 34 59 00 00       	push   $0x5934
    31f4:	50                   	push   %eax
    31f5:	e8 5f 0f 00 00       	call   4159 <printf>
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    3253:	68 50 59 00 00       	push   $0x5950
    3258:	50                   	push   %eax
    3259:	e8 fb 0e 00 00       	call   4159 <printf>
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    32a4:	68 8e 59 00 00       	push   $0x598e
    32a9:	50                   	push   %eax
    32aa:	e8 aa 0e 00 00       	call   4159 <printf>
  ...
  if(c != a - 4096){
    ...
    32df:	68 ac 59 00 00       	push   $0x59ac
    32e4:	50                   	push   %eax
    32e5:	e8 6f 0e 00 00       	call   4159 <printf>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3343:	68 e4 59 00 00       	push   $0x59e4
    3348:	50                   	push   %eax
    3349:	e8 0b 0e 00 00       	call   4159 <printf>
  ...
  if(*lastaddr == 99){
    ...
    3368:	68 0c 5a 00 00       	push   $0x5a0c
    336d:	50                   	push   %eax
    336e:	e8 e6 0d 00 00       	call   4159 <printf>
  ...
  if(c != a){
    ...
    33c1:	68 3c 5a 00 00       	push   $0x5a3c
    33c6:	50                   	push   %eax
    33c7:	e8 8d 0d 00 00       	call   4159 <printf>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33fb:	68 b1 45 00 00       	push   $0x45b1
    3400:	50                   	push   %eax
    3401:	e8 53 0d 00 00       	call   4159 <printf>
    ...
    3426:	68 5d 5a 00 00       	push   $0x5a5d
    342b:	50                   	push   %eax
    342c:	e8 28 0d 00 00       	call   4159 <printf>
  ...
  if(pipe(fds) != 0){
    ...
    3472:	68 82 49 00 00       	push   $0x4982
    3477:	6a 01                	push   $0x1
    3479:	e8 db 0c 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d3:	6a 01                	push   $0x1
    34d5:	68 e7 49 00 00       	push   $0x49e7
    34da:	50                   	push   %eax
  ...
  if(c == (char*)0xffffffff){
    ...
    3583:	68 76 5a 00 00       	push   $0x5a76
    3588:	50                   	push   %eax
    3589:	e8 cb 0b 00 00       	call   4159 <printf>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    35d0:	68 91 5a 00 00       	push   $0x5a91
    35d5:	50                   	push   %eax
    35d6:	e8 7e 0b 00 00       	call   4159 <printf>
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    3615:	68 9f 5a 00 00       	push   $0x5a9f
    361a:	50                   	push   %eax
    361b:	e8 39 0b 00 00       	call   4159 <printf>
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    368b:	50                   	push   %eax
    368c:	68 ae 5a 00 00       	push   $0x5aae
    ...
    36a6:	68 b9 5a 00 00       	push   $0x5ab9
    36ab:	50                   	push   %eax
    36ac:	e8 a8 0a 00 00       	call   4159 <printf>
  ...
  printf(stdout, "validate ok\n");
    ...
    36d4:	68 d2 5a 00 00       	push   $0x5ad2
    36d9:	50                   	push   %eax
    36da:	e8 7a 0a 00 00       	call   4159 <printf>
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    ...
    36f3:	68 df 5a 00 00       	push   $0x5adf
    36f8:	50                   	push   %eax
    36f9:	e8 5b 0a 00 00       	call   4159 <printf>
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3721:	68 e9 5a 00 00       	push   $0x5ae9
    3726:	50                   	push   %eax
    3727:	e8 2d 0a 00 00       	call   4159 <printf>
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    ...
    374a:	68 fa 5a 00 00       	push   $0x5afa
    374f:	50                   	push   %eax
    3750:	e8 04 0a 00 00       	call   4159 <printf>
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    3764:	68 07 5b 00 00       	push   $0x5b07
  ...
  if(pid == 0){
    ...
    378f:	c7 04 85 20 64 00 00 	movl   $0x5b14,0x6420(,%eax,4)
    3796:	14 5b 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    37b6:	68 f1 5b 00 00       	push   $0x5bf1
    37bb:	50                   	push   %eax
    37bc:	e8 98 09 00 00       	call   4159 <printf>
    37c1:	83 c4 10             	add    $0x10,%esp
    exec("echo", args);
    37c4:	83 ec 08             	sub    $0x8,%esp
    37c7:	68 20 64 00 00       	push   $0x6420
    37cc:	68 10 45 00 00       	push   $0x4510
    ...
    37e1:	68 fe 5b 00 00       	push   $0x5bfe
    37e6:	50                   	push   %eax
    37e7:	e8 6d 09 00 00       	call   4159 <printf>
    37ec:	83 c4 10             	add    $0x10,%esp
    fd = open("bigarg-ok", O_CREATE);
    37ef:	83 ec 08             	sub    $0x8,%esp
    37f2:	68 00 02 00 00       	push   $0x200
    37f7:	68 07 5b 00 00       	push   $0x5b07
    ...
    3828:	68 0e 5c 00 00       	push   $0x5c0e
    382d:	50                   	push   %eax
    382e:	e8 26 09 00 00       	call   4159 <printf>
  ...
  fd = open("bigarg-ok", 0);
    ...
    3843:	6a 00                	push   $0x0
    3845:	68 07 5b 00 00       	push   $0x5b07
  ...
  if(fd < 0){
    ...
    3863:	68 27 5c 00 00       	push   $0x5c27
    3868:	50                   	push   %eax
    3869:	e8 eb 08 00 00       	call   4159 <printf>
  ...
  unlink("bigarg-ok");
    ...
    3887:	68 07 5b 00 00       	push   $0x5b07
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    ...
    38a8:	68 3c 5c 00 00       	push   $0x5c3c
    38ad:	6a 01                	push   $0x1
    38af:	e8 a5 08 00 00       	call   4159 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    398c:	50                   	push   %eax
    398d:	68 49 5c 00 00       	push   $0x5c49
    3992:	6a 01                	push   $0x1
    3994:	e8 c0 07 00 00       	call   4159 <printf>
    ...
    39bf:	50                   	push   %eax
    39c0:	68 55 5c 00 00       	push   $0x5c55
    39c5:	6a 01                	push   $0x1
    39c7:	e8 8d 07 00 00       	call   4159 <printf>
    ...
    3a0f:	68 65 5c 00 00       	push   $0x5c65
    3a14:	6a 01                	push   $0x1
    3a16:	e8 3e 07 00 00       	call   4159 <printf>
  ...
  printf(1, "fsfull test finished\n");
    ...
    3b29:	68 75 5c 00 00       	push   $0x5c75
    3b2e:	6a 01                	push   $0x1
    3b30:	e8 24 06 00 00       	call   4159 <printf>
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    ...
    3b71:	68 8b 5c 00 00       	push   $0x5c8b
    3b76:	6a 01                	push   $0x1
    3b78:	e8 dc 05 00 00       	call   4159 <printf>
    3b7d:	83 c4 10             	add    $0x10,%esp

  if(open("usertests.ran", 0) >= 0){
    3b80:	83 ec 08             	sub    $0x8,%esp
    3b83:	6a 00                	push   $0x0
    3b85:	68 9f 5c 00 00       	push   $0x5c9f
    ...
    3b99:	68 b0 5c 00 00       	push   $0x5cb0
    3b9e:	6a 01                	push   $0x1
    3ba0:	e8 b4 05 00 00       	call   4159 <printf>
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3bb5:	68 9f 5c 00 00       	push   $0x5c9f
...
{
    4082:	55                   	push   %ebp
    4083:	89 e5                	mov    %esp,%ebp
    4085:	83 ec 18             	sub    $0x18,%esp
    4088:	8b 45 0c             	mov    0xc(%ebp),%eax
    408b:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    408e:	83 ec 04             	sub    $0x4,%esp
    4091:	6a 01                	push   $0x1
    4093:	8d 45 f4             	lea    -0xc(%ebp),%eax
    4096:	50                   	push   %eax
    4097:	ff 75 08             	pushl  0x8(%ebp)
    409a:	e8 23 ff ff ff       	call   3fc2 <write>
    409f:	83 c4 10             	add    $0x10,%esp
}
    40a2:	90                   	nop
    40a3:	c9                   	leave  
    40a4:	c3                   	ret    
...
{
    40a5:	55                   	push   %ebp
    40a6:	89 e5                	mov    %esp,%ebp
    40a8:	53                   	push   %ebx
    40a9:	83 ec 24             	sub    $0x24,%esp
  ...
  neg = 0;
    40ac:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    40b3:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    40b7:	74 17                	je     40d0 <printint+0x2b>
    40b9:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    40bd:	79 11                	jns    40d0 <printint+0x2b>
    neg = 1;
    40bf:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    40c6:	8b 45 0c             	mov    0xc(%ebp),%eax
    40c9:	f7 d8                	neg    %eax
    40cb:	89 45 ec             	mov    %eax,-0x14(%ebp)
    40ce:	eb 06                	jmp    40d6 <printint+0x31>
  } else {
    x = xx;
  ...
  i = 0;
    40d6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    40dd:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    40e0:	8d 41 01             	lea    0x1(%ecx),%eax
    40e3:	89 45 f4             	mov    %eax,-0xc(%ebp)
    40e6:	8b 5d 10             	mov    0x10(%ebp),%ebx
    40e9:	8b 45 ec             	mov    -0x14(%ebp),%eax
    40ec:	ba 00 00 00 00       	mov    $0x0,%edx
    40f1:	f7 f3                	div    %ebx
    40f3:	89 d0                	mov    %edx,%eax
    40f5:	0f b6 80 f4 63 00 00 	movzbl 0x63f4(%eax),%eax
    40fc:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    4100:	8b 5d 10             	mov    0x10(%ebp),%ebx
    4103:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4106:	ba 00 00 00 00       	mov    $0x0,%edx
    410b:	f7 f3                	div    %ebx
    410d:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4110:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4114:	75 c7                	jne    40dd <printint+0x38>
  if(neg)
    4116:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    411a:	74 2d                	je     4149 <printint+0xa4>
    buf[i++] = '-';
    411c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    411f:	8d 50 01             	lea    0x1(%eax),%edx
    4122:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4125:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    412a:	eb 1d                	jmp    4149 <printint+0xa4>
    putc(fd, buf[i]);
    412c:	8d 55 dc             	lea    -0x24(%ebp),%edx
    412f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4132:	01 d0                	add    %edx,%eax
    4134:	0f b6 00             	movzbl (%eax),%eax
    4137:	0f be c0             	movsbl %al,%eax
    413a:	83 ec 08             	sub    $0x8,%esp
    413d:	50                   	push   %eax
    413e:	ff 75 08             	pushl  0x8(%ebp)
    4141:	e8 3c ff ff ff       	call   4082 <putc>
  ...
  while(--i >= 0)
    4149:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    414d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4151:	79 d9                	jns    412c <printint+0x87>
    putc(fd, buf[i]);
}
    4153:	90                   	nop
    4154:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    4157:	c9                   	leave  
    4158:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    415c:	83 ec 28             	sub    $0x28,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    415f:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    4166:	8d 45 0c             	lea    0xc(%ebp),%eax
    4169:	83 c0 04             	add    $0x4,%eax
    416c:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    416f:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    4176:	e9 59 01 00 00       	jmp    42d4 <printf+0x17b>
    c = fmt[i] & 0xff;
    417b:	8b 55 0c             	mov    0xc(%ebp),%edx
    417e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4181:	01 d0                	add    %edx,%eax
    4183:	0f b6 00             	movzbl (%eax),%eax
    4186:	0f be c0             	movsbl %al,%eax
    4189:	25 ff 00 00 00       	and    $0xff,%eax
    418e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    4191:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4195:	75 2c                	jne    41c3 <printf+0x6a>
      if(c == '%'){
    4197:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    419b:	75 0c                	jne    41a9 <printf+0x50>
        state = '%';
    419d:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    41a4:	e9 27 01 00 00       	jmp    42d0 <printf+0x177>
      } else {
        putc(fd, c);
    ...
    41b6:	e8 c7 fe ff ff       	call   4082 <putc>
    41bb:	83 c4 10             	add    $0x10,%esp
    41be:	e9 0d 01 00 00       	jmp    42d0 <printf+0x177>
      }
    } else if(state == '%'){
    41c3:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    41c7:	0f 85 03 01 00 00    	jne    42d0 <printf+0x177>
      if(c == 'd'){
    41cd:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    41d1:	75 1e                	jne    41f1 <printf+0x98>
        printint(fd, *ap, 10, 1);
    41d3:	8b 45 e8             	mov    -0x18(%ebp),%eax
    41d6:	8b 00                	mov    (%eax),%eax
    41d8:	6a 01                	push   $0x1
    41da:	6a 0a                	push   $0xa
    41dc:	50                   	push   %eax
    41dd:	ff 75 08             	pushl  0x8(%ebp)
    41e0:	e8 c0 fe ff ff       	call   40a5 <printint>
    41e5:	83 c4 10             	add    $0x10,%esp
        ap++;
    41e8:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    41ec:	e9 d8 00 00 00       	jmp    42c9 <printf+0x170>
      } else if(c == 'x' || c == 'p'){
    41f1:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    41f5:	74 06                	je     41fd <printf+0xa4>
    41f7:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    41fb:	75 1e                	jne    421b <printf+0xc2>
        printint(fd, *ap, 16, 0);
    41fd:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4200:	8b 00                	mov    (%eax),%eax
    4202:	6a 00                	push   $0x0
    4204:	6a 10                	push   $0x10
    4206:	50                   	push   %eax
    4207:	ff 75 08             	pushl  0x8(%ebp)
    420a:	e8 96 fe ff ff       	call   40a5 <printint>
    420f:	83 c4 10             	add    $0x10,%esp
        ap++;
    4212:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4216:	e9 ae 00 00 00       	jmp    42c9 <printf+0x170>
      } else if(c == 's'){
    421b:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    421f:	75 43                	jne    4264 <printf+0x10b>
        s = (char*)*ap;
    4221:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4224:	8b 00                	mov    (%eax),%eax
    4226:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    4229:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    422d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4231:	75 25                	jne    4258 <printf+0xff>
          s = "(null)";
    4233:	c7 45 f4 da 5c 00 00 	movl   $0x5cda,-0xc(%ebp)
        while(*s != 0){
    423a:	eb 1c                	jmp    4258 <printf+0xff>
          putc(fd, *s);
    423c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    423f:	0f b6 00             	movzbl (%eax),%eax
    4242:	0f be c0             	movsbl %al,%eax
    4245:	83 ec 08             	sub    $0x8,%esp
    4248:	50                   	push   %eax
    4249:	ff 75 08             	pushl  0x8(%ebp)
    424c:	e8 31 fe ff ff       	call   4082 <putc>
    4251:	83 c4 10             	add    $0x10,%esp
          s++;
    4254:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    4260:	75 da                	jne    423c <printf+0xe3>
    4262:	eb 65                	jmp    42c9 <printf+0x170>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    4264:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    4268:	75 1d                	jne    4287 <printf+0x12e>
        putc(fd, *ap);
    426a:	8b 45 e8             	mov    -0x18(%ebp),%eax
    426d:	8b 00                	mov    (%eax),%eax
    426f:	0f be c0             	movsbl %al,%eax
    4272:	83 ec 08             	sub    $0x8,%esp
    4275:	50                   	push   %eax
    4276:	ff 75 08             	pushl  0x8(%ebp)
    4279:	e8 04 fe ff ff       	call   4082 <putc>
    427e:	83 c4 10             	add    $0x10,%esp
        ap++;
    4281:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4285:	eb 42                	jmp    42c9 <printf+0x170>
      } else if(c == '%'){
    4287:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    428b:	75 17                	jne    42a4 <printf+0x14b>
        putc(fd, c);
    428d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4290:	0f be c0             	movsbl %al,%eax
    4293:	83 ec 08             	sub    $0x8,%esp
    4296:	50                   	push   %eax
    4297:	ff 75 08             	pushl  0x8(%ebp)
    429a:	e8 e3 fd ff ff       	call   4082 <putc>
    429f:	83 c4 10             	add    $0x10,%esp
    42a2:	eb 25                	jmp    42c9 <printf+0x170>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    42a4:	83 ec 08             	sub    $0x8,%esp
    42a7:	6a 25                	push   $0x25
    42a9:	ff 75 08             	pushl  0x8(%ebp)
    42ac:	e8 d1 fd ff ff       	call   4082 <putc>
    42b1:	83 c4 10             	add    $0x10,%esp
        putc(fd, c);
    42b4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    42b7:	0f be c0             	movsbl %al,%eax
    42ba:	83 ec 08             	sub    $0x8,%esp
    42bd:	50                   	push   %eax
    42be:	ff 75 08             	pushl  0x8(%ebp)
    42c1:	e8 bc fd ff ff       	call   4082 <putc>
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    42d0:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    42d4:	8b 55 0c             	mov    0xc(%ebp),%edx
    42d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
    42da:	01 d0                	add    %edx,%eax
    42dc:	0f b6 00             	movzbl (%eax),%eax
    42df:	84 c0                	test   %al,%al
    42e1:	0f 85 94 fe ff ff    	jne    417b <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    42ed:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    42f0:	8b 45 08             	mov    0x8(%ebp),%eax
    42f3:	83 e8 08             	sub    $0x8,%eax
    42f6:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    42f9:	a1 a8 64 00 00       	mov    0x64a8,%eax
    42fe:	89 45 fc             	mov    %eax,-0x4(%ebp)
    4301:	eb 24                	jmp    4327 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4303:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4306:	8b 00                	mov    (%eax),%eax
    4308:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    430b:	77 12                	ja     431f <free+0x35>
    430d:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4310:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4313:	77 24                	ja     4339 <free+0x4f>
    4315:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4318:	8b 00                	mov    (%eax),%eax
    431a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    431d:	77 1a                	ja     4339 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  bp = (Header*)ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    431f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4322:	8b 00                	mov    (%eax),%eax
    4324:	89 45 fc             	mov    %eax,-0x4(%ebp)
    4327:	8b 45 f8             	mov    -0x8(%ebp),%eax
    432a:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    432d:	76 d4                	jbe    4303 <free+0x19>
    432f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4332:	8b 00                	mov    (%eax),%eax
    4334:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4337:	76 ca                	jbe    4303 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    4339:	8b 45 f8             	mov    -0x8(%ebp),%eax
    433c:	8b 40 04             	mov    0x4(%eax),%eax
    433f:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4346:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4349:	01 c2                	add    %eax,%edx
    434b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    434e:	8b 00                	mov    (%eax),%eax
    4350:	39 c2                	cmp    %eax,%edx
    4352:	75 24                	jne    4378 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    4354:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4357:	8b 50 04             	mov    0x4(%eax),%edx
    ...
    436f:	8b 10                	mov    (%eax),%edx
    4371:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4374:	89 10                	mov    %edx,(%eax)
    4376:	eb 0a                	jmp    4382 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    4378:	8b 45 fc             	mov    -0x4(%ebp),%eax
    437b:	8b 10                	mov    (%eax),%edx
    437d:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4380:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    4382:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4385:	8b 40 04             	mov    0x4(%eax),%eax
    4388:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    438f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4392:	01 d0                	add    %edx,%eax
    4394:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4397:	75 20                	jne    43b9 <free+0xcf>
    p->s.size += bp->s.size;
    4399:	8b 45 fc             	mov    -0x4(%ebp),%eax
    439c:	8b 50 04             	mov    0x4(%eax),%edx
    ...
    43b7:	eb 08                	jmp    43c1 <free+0xd7>
  } else
    p->s.ptr = bp;
    43b9:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43bc:	8b 55 f8             	mov    -0x8(%ebp),%edx
    43bf:	89 10                	mov    %edx,(%eax)
  freep = p;
    43c1:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43c4:	a3 a8 64 00 00       	mov    %eax,0x64a8
}
    43c9:	90                   	nop
    43ca:	c9                   	leave  
    43cb:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    43d2:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    43d9:	77 07                	ja     43e2 <morecore+0x16>
    nu = 4096;
    43db:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    43e2:	8b 45 08             	mov    0x8(%ebp),%eax
    43e5:	c1 e0 03             	shl    $0x3,%eax
    43e8:	83 ec 0c             	sub    $0xc,%esp
    43eb:	50                   	push   %eax
    43ec:	e8 39 fc ff ff       	call   402a <sbrk>
    43f1:	83 c4 10             	add    $0x10,%esp
    43f4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    43f7:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    43fb:	75 07                	jne    4404 <morecore+0x38>
    return 0;
    43fd:	b8 00 00 00 00       	mov    $0x0,%eax
    4402:	eb 26                	jmp    442a <morecore+0x5e>
  hp = (Header*)p;
    4404:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4407:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    440a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    440d:	8b 55 08             	mov    0x8(%ebp),%edx
    4410:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    4413:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4416:	83 c0 08             	add    $0x8,%eax
    4419:	83 ec 0c             	sub    $0xc,%esp
    441c:	50                   	push   %eax
    441d:	e8 c8 fe ff ff       	call   42ea <free>
    4422:	83 c4 10             	add    $0x10,%esp
  return freep;
    4425:	a1 a8 64 00 00       	mov    0x64a8,%eax
}
    442a:	c9                   	leave  
    442b:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    442f:	83 ec 18             	sub    $0x18,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4432:	8b 45 08             	mov    0x8(%ebp),%eax
    4435:	83 c0 07             	add    $0x7,%eax
    4438:	c1 e8 03             	shr    $0x3,%eax
    443b:	83 c0 01             	add    $0x1,%eax
    443e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    4441:	a1 a8 64 00 00       	mov    0x64a8,%eax
    4446:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4449:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    444d:	75 23                	jne    4472 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    444f:	c7 45 f0 a0 64 00 00 	movl   $0x64a0,-0x10(%ebp)
    4456:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4459:	a3 a8 64 00 00       	mov    %eax,0x64a8
    445e:	a1 a8 64 00 00       	mov    0x64a8,%eax
    4463:	a3 a0 64 00 00       	mov    %eax,0x64a0
    base.s.size = 0;
    4468:	c7 05 a4 64 00 00 00 	movl   $0x0,0x64a4
    446f:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    447d:	8b 40 04             	mov    0x4(%eax),%eax
    4480:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4483:	72 4d                	jb     44d2 <malloc+0xa6>
      if(p->s.size == nunits)
    4485:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4488:	8b 40 04             	mov    0x4(%eax),%eax
    448b:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    448e:	75 0c                	jne    449c <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    4490:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4493:	8b 10                	mov    (%eax),%edx
    4495:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4498:	89 10                	mov    %edx,(%eax)
    449a:	eb 26                	jmp    44c2 <malloc+0x96>
      else {
        p->s.size -= nunits;
    449c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    449f:	8b 40 04             	mov    0x4(%eax),%eax
    44a2:	2b 45 ec             	sub    -0x14(%ebp),%eax
    44a5:	89 c2                	mov    %eax,%edx
    44a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44aa:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    44ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44b0:	8b 40 04             	mov    0x4(%eax),%eax
    44b3:	c1 e0 03             	shl    $0x3,%eax
    44b6:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    44b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44bc:	8b 55 ec             	mov    -0x14(%ebp),%edx
    44bf:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    44c2:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44c5:	a3 a8 64 00 00       	mov    %eax,0x64a8
      return (void*)(p + 1);
    44ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44cd:	83 c0 08             	add    $0x8,%eax
    44d0:	eb 3b                	jmp    450d <malloc+0xe1>
    }
    if(p == freep)
    44d2:	a1 a8 64 00 00       	mov    0x64a8,%eax
    44d7:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    44da:	75 1e                	jne    44fa <malloc+0xce>
      if((p = morecore(nunits)) == 0)
    44dc:	83 ec 0c             	sub    $0xc,%esp
    44df:	ff 75 ec             	pushl  -0x14(%ebp)
    44e2:	e8 e5 fe ff ff       	call   43cc <morecore>
    44e7:	83 c4 10             	add    $0x10,%esp
    44ea:	89 45 f4             	mov    %eax,-0xc(%ebp)
    44ed:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    44f1:	75 07                	jne    44fa <malloc+0xce>
        return 0;
    44f3:	b8 00 00 00 00       	mov    $0x0,%eax
    44f8:	eb 13                	jmp    450d <malloc+0xe1>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    44fd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4500:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4503:	8b 00                	mov    (%eax),%eax
    4505:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    4508:	e9 6d ff ff ff       	jmp    447a <malloc+0x4e>
}
    450d:	c9                   	leave  
    450e:	c3                   	ret    
