...
00000535 <chgrp>:
SYSCALL(chgrp)
 535:	b8 21 00 00 00       	mov    $0x21,%eax
 53a:	cd 40                	int    $0x40
 53c:	c3                   	ret    
